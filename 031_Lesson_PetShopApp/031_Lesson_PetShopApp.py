...
class Inventory:
  ...
  def save(self):
    ...
    with open('031_Lesson_PetShopApp/inventory.txt', 'w') as f:
      json.dump(self.pets, f)
    print('Saved!')

  def load(self):
    print('Loading inventory')
    if not os.path.exists('031_Lesson_PetShopApp/inventory.txt'):
      print('Skipping, nothing to load')
      return
    
    with open('031_Lesson_PetShopApp/inventory.txt', 'r') as f:
